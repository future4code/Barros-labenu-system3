...
const createTables = () => connection.raw(`
  ...
  CREATE TABLE estudante (
   ...
   CREATE TABLE hobby_estudante(
      ...
      FOREING KEY (id_estudante) REFERENCES estudante(id),
      FOREING KEY (id_hooby) REFERENCES hooby(id)
   );
  ...
  CREATE TABLE docente_especialidade(
    ...
    FOREING KEY (id_docente) REFERENCES docente(id),
    FOREING KEY (id_especialidade) REFERENCES especialidade(id)
  )
